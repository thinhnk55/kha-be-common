...
/**
 * Utility class for parsing and validating version source configurations.
 *
 * <p>
...
@Slf4j
public class VersionSourceParser {
    /**
     ...
     */
    public static VersionSourceConfig parse(String policySource) {
        ...
        return VersionSourceConfig.builder()
                .type(type)
                .query(query)
                .build();
    }
    ...
    private static void validatePolicyType(String type) {
        if (!"database".equals(type) && !"api".equals(type)) {
    ...
    @Data
    @lombok.Builder
    public static class VersionSourceConfig {
        /**
